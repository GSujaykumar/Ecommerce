      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 space-y-16">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-10">
            <div className="flex items-start gap-6 bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition">
              <div className="p-4 bg-black text-white rounded-full">
                <FiMapPin size={28} />
              </div>
              <div>
                <h4 className="font-semibold text-gray-900 text-lg">Address</h4>
                <p className="text-gray-600">123 Luxe Street, Fashion City, NY 10001</p>
              </div>
            </div>
            <div className="flex items-start gap-6 bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition">
              <div className="p-4 bg-black text-white rounded-full">
          ...
          {/* Contact Form */}
          <form className="bg-white p-12 rounded-3xl shadow-lg space-y-6 hover:shadow-xl transition">
